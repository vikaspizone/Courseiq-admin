...
export function useRouteGuard() {
  ...
  const isAccessDenied = useMemo(() => {
    ...
    // Find if the current route matches any module route
    ...
    return false;
  }, [pathname, modules, hasModuleAccess, userProfile, authLoading, modulesLoading, language]);

  return { isAccessDenied, authLoading };
}
